...
// Eager load landing and login pages for better first impression
import RoomyLanding from './LandingPage/RoomyLanding';
import Login from './Login/Login';
import ApartmentsMinimal from './Apartments/ApartmentsMinimal';
      ...
      <Router>
        <Suspense fallback={<LoadingFallback />}>
          <Routes>
            ...
            <Route path="/apartments" element={<ApartmentsMinimal />} />
